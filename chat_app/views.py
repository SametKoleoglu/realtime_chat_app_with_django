...
def index(request):
    ...
    rec_chats = ChatMessage.objects.filter(msg_receiver=user, seen=False).first()
    content = rec_chats.body
    context = {"user": user, "friends": friends, "content": content}
...
def detail(request, pk):
    ...
    return render(request, "chat_app/detail.html", context)
